    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (liquidEffect && 'uniforms' in liquidEffect) {
          const liquidUniforms = liquidEffect.uniforms;
          ...
          composer.passes.forEach(p => {
            if ('effects' in p) {
              ...
              effects.forEach((eff: Effect) => {
                if ('uniforms' in eff && eff.uniforms instanceof Map) {
      ...
      if (t.liquidEffect && 'uniforms' in t.liquidEffect) {
        const uniforms = t.liquidEffect.uniforms;
        const uStrength = uniforms.get('uStrength');
        if (uStrength) uStrength.value = liquidStrength;
        const uFreq = uniforms.get('uFreq');
